...
if qGenCacheFile || qDEBUG
    ...
    for p=1:1+qHasEyeVideo
        ...
        timeStamps(lastFrame+1:end) = [];   % NB: always throws away at least the last timeStamp. this is expected as it is the end of the last frame, not the start which is what we're interested in
